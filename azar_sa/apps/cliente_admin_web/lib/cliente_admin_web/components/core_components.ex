defmodule ClienteAdminWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} action={@action} as={@as} {@rest}>
      <div class="mt-10 space-y-8 bg-white p-8 rounded-2xl shadow-lg border border-slate-100">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClienteAdminWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClienteAdminWeb.Gettext, "errors", msg, opts)
    end
  end
